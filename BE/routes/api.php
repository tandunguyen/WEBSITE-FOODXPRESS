...
// Admin - đơn đặt
Route::get('/admin/don-hang/chi-tiet/{id}', [DonHangController::class, 'getChiTietDonHangAdmin']);
...
Route::post('/admin/don-hang/huy', [DonHangController::class, 'huyDonHangAdmin'])->middleware('adminMiddle');
...
// Admin- Xem chi tiết và xác nhận đơn hàng
Route::post('/admin/don-hang/xac-nhan-don-hang', [DonHangController::class, 'xacNhanDonHangAdmin'])->middleware('nhanVienMiddle');
Route::get('/admin/don-hang/chi-tiet/{id}', [DonHangController::class, 'getChiTietDonHangAdmin'])->middleware('nhanVienMiddle');
Route::get('/donhang/{id}/chitiet', [DonHangController::class, 'chiTietDonHangFull']);
...
Route::post('/shipper/don-hang/update-trang-thai', [DonHangController::class, 'updateTrangThai'])->middleware('shipperMiddle');
...
Route::get('/khach-hang/don-hang/hoa-don/{id}', [DonHangController::class, 'xemHoaDon'])->middleware('khachHangMiddle');
...
//khachhang/quenmatkhau
Route::post('khach-hang/quen-mat-khau/xac-thuc', [KhachHangController::class, 'xacThucMaQuenMatKhau']);
Route::post('khach-hang/quen-mat-khau/gui-ma', [KhachHangController::class, 'guiMaQuenMatKhau']);
Route::post('khach-hang/quen-mat-khau/dat-lai', [KhachHangController::class, 'datLaiMatKhau']);


//---------------------------SHIPPER - QUÊN MẬT KHẨU----------------------------
// shipper/quenmatkhau
Route::post('shipper/quen-mat-khau/gui-ma', [ShipperController::class, 'guiMaQuenMatKhau']);
Route::post('shipper/quen-mat-khau/xac-thuc', [ShipperController::class, 'xacThucMaQuenMatKhau']);
Route::post('shipper/quen-mat-khau/dat-lai', [ShipperController::class, 'datLaiMatKhau']);


// quanan/quenmatkhau
Route::post('quan-an/quen-mat-khau/gui-ma', [QuanAnController::class, 'guiMaQuenMatKhau']);
Route::post('quan-an/quen-mat-khau/xac-thuc', [QuanAnController::class, 'xacThucMaQuenMatKhau']);
Route::post('quan-an/quen-mat-khau/dat-lai', [QuanAnController::class, 'datLaiMatKhau']);


// tich hop AI
Route::post('customer/chat', [ChatBotController::class, 'chat']);

Route::post('customer/chat/train/static',    [TrainChatController::class, 'trainStatic']);
Route::post('customer/chat/train/quan-an',   [TrainChatController::class, 'trainQuanAn']);
Route::post('customer/chat/train/mon-an',    [TrainChatController::class, 'trainMonAn']);
Route::post('customer/chat/train/vouchers',  [TrainChatController::class, 'trainVouchers']);
Route::post('customer/chat/train/don-hang',  [TrainChatController::class, 'trainDonHang']);

Route::post('customer/chat/train-all',       [TrainChatController::class, 'trainAll']);
